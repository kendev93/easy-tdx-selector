...
浏览器打开 <http://127.0.0.1:5173/formula-screen>。单股回测页面是 <http://127.0.0.1:5173/backtest>，动态组合回测页面是 <http://127.0.0.1:5173/portfolio-backtest>；Vite 会把 `/api` 请求代理到 `127.0.0.1:8000`。
